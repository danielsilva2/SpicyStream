...
export default function SavedPage() {
  const { data: savedContent, isLoading } = useQuery<Content[]>({
    queryKey: ["/api/saved"],
  });
  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-bg">
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-neutral-dark">Saved Content</h1>
          </div>
          ...
          {isLoading ? (
            ...
            <ContentGrid content={savedContent} />
          ) : (
            <div className="text-center py-20">
              <h3 className="text-xl font-medium text-neutral-dark mb-2">No saved content</h3>
              <p className="text-gray-500 mb-6">Content you save will appear here</p>
      ...
      <MobileNavigation activeTab="saved" />
    </div>
  );
}
